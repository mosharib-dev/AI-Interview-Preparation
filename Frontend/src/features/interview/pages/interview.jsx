...
const Interview = () => {
    ...
    const { report, getReportById, loading, error, downloading, getResumePdf } = useInterview()
    ...
    const handleDownloadResume = async () => {
        ...
        try {
            ...
            setDownloadError(getErrorMessage(err, "Couldn't download the resume. Please try again."))
        }
    }
        ...
        return (
            <main className='interview-page interview-page--error'>
                <div className='interview-error'>
                    ...
                    <p>{error || "This interview report doesn't exist or you don't have access to it."}</p>
            ...
            <div className='interview-layout'>
                ...
                <nav className='interview-nav'>
                    ...
                    <button
                        ...
                        {downloading
                            ? <span className='spinner' style={{ marginRight: "0.8rem" }} />
